...
def build_rlgym_sim_env():
    ...
    state_mutator = MutatorSequence(FixedTeamSizeMutator(bluep_size=blue_team_size, orange_size=orange_team_size),
                                    KickoffMutator())
    rlgym_env = RLGym(
...
if __name__ == "__main__":
    ...
    checkpoints_save_folder=os.path.join(ROOT_DIR, "data", "checkpoints", "rlgym-ppo-run")

    learner = Learner(build_rlgym_sim_env,
                      n_proc=n_proc,
